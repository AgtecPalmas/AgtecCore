...
/// Construtor nomeado que retorna uma instância com todos os atributos vazios
  ...
  String get profileName {
    try {
      ...
      AppLogger().erro('Ocorreu o erro no AuthModel profileName', error, stackTrace);
    }
    return '';
  }
  ...
  factory AuthModel.fromMap(Map<String, dynamic> map) {
    try {
      ...
      AppLogger().erro('Ocorreu o erro no AuthModel fromMap', error, stackTrace);
      return AuthModel();
    }
  }
  ...
  Map<String, dynamic> toMap() {
    try {
      ...
      AppLogger().erro('Ocorreu o erro no AuthModel toMap', error, stackTrace);
      return {};
    }
  }
