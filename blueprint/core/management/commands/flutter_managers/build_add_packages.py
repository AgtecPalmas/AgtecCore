...
class AddPackagesBuilder:
    def __init__(self, command) -> None:
        ...
        self._yaml_file_snippet = Path(f"{self._snippet_dir}/cubit/yaml.txt")
    ...
    def build(self):
        ...
        try:
            ...
            Utils.show_error(f"Erro ao executar o build de AddPackagesBuilder: {error}")
            return
