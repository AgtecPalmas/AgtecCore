...
class AppsMobileCubitStateManagerBuilder:
    def __init__(self, command, app) -> None:
        self.command = command
        self.app = app
        self.flutter_dir = self.command.flutter_dir
        self.flutter_state_snippet = Path(
            f"{self.command.path_command}/snippets/flutter_mobile_project/layers/state.txt"
        )
        self.flutter_controller_snippet = Path(
            f"{self.command.path_command}/snippets/flutter_mobile_project/layers/controller.txt"
        )
    ...
    def build(self):
        ...
        try:
            ...
            for model in self._models_app:
                ...
                _state_file = Path(f"{self.flutter_dir}/lib/apps/{_model_app_lower}/states/{_model_name_lower}.dart")
                Utils.show_message(
                ...
                _controller_file = Path(f"{self.flutter_dir}/lib/apps/{_model_app_lower}/controllers/{_model_name_lower}.dart")
                Utils.show_message(
