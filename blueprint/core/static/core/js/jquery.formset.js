    ...
    $.fn.formset = function (opts) {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            */
            ...
            insertDeleteLink = function (row) {
                ...
                var delButtonHTML = '<div class="flex-buttons-end"><a class="' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText + '</a></div>';
                ...
                row.find('a.' + delCssSelector).click(function () {
                    ...
                    for (var i = 0, formCount = forms.length; i < formCount; i++) { // Apply `extraClasses` to form rows so they're nicely alternating:
        ...
        if ($$.length) {
            var hideAddButton = ! showAddButton(),
                addButton,
                template;
            if (options.formTemplate) { // If a form template was specified, we'll clone it to generate new form instances:
            ...
            var addButtonHTML = '<div class="flex-buttons-end mb-3 m-2"><a class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a></div>';
            ...
            } else { // Otherwise, insert it immediately after the last form:
