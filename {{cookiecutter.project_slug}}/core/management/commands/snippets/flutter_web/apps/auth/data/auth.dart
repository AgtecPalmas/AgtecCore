...
class AuthData implements LocalDataInterface {
  ...
  Future<Either<Exception, bool>> isInitialized() async {
    try {
      ...
      NuvolsCoreLogger().erro('Error initializing database', error, stackTrace);
  ...
  Future<Either<Exception, AuthModel>> update<AuthModel>(AuthModel data) async {
    try {
      ...
      NuvolsCoreLogger().erro('Error updating database', error, stackTrace);
  ...
  Future<Either<Exception, bool>> delete({required int id}) async {
    try {
      ...
      NuvolsCoreLogger().erro('Error deleting item from database', error, stackTrace);
  ...
  Future<Either<Exception, bool>> deleteAll() async {
    try {
      ...
      NuvolsCoreLogger().erro('Error deleting all items from database', error, stackTrace);
  ...
  Future<Either<Exception, List<AuthModel>>> fetch<AuthModel>() async {
    try {
      ...
      NuvolsCoreLogger().erro('Error fetching data from database', error, stackTrace);
  ...
  Future<Either<Exception, AuthModel>> get<AuthModel>({required int id}) async {
    try {
      ...
      NuvolsCoreLogger().erro('Error getting item from database', error, stackTrace);
  ...
  Future<Either<Exception, bool>> insert<AuthModel>(AuthModel data) async {
    try {
      ...
      NuvolsCoreLogger().erro('Error inserting item into database', error, stackTrace);
