...
class Command(BaseCommand):
    help = """Manager responsável por criar o projeto Flutter Mobile"""
    ...
    def __init__(self):
        ...
        self.flutter_dir = str(Path(f"{self.path_root}/FlutterMobile/{self.project.lower()}"))
        ...
        self.snippet_dir = str(
            Path(f"{self.path_core}/management/commands/snippets/flutter_mobile_project")
        )
    ...
    def _init_flutter(self):
        try:
            if not Utils.check_dir(self.flutter_dir):
                Utils.show_message("Criando projeto Flutter Mobile..")
    ...
    def _copy_defaults_directories(self):
        ...
        """
        try:
            Utils.show_message("Criando o diretório core do projeto Flutter Mobile")
            FlutterMobileBuildProject(command=self).build()
        except Exception as error:
    ...
    def _replace_main(self):
        ...
        try:
            ...
            MainFileMobileBuilder(command=self).build()
        except Exception as error:
    ...
    def _add_analysis_options(self):
        ...
        try:
            ...
            AddAnalysisOptionsMobileBuilder(command=self).build()
        except Exception as error:
    ...
    def _add_packages(self):
        ...
        try:
            ...
            AddPackagesMobileBuilder(command=self).build()
        except Exception as error:
            Utils.show_error(f"Error in _add_packages: {error}")

    def _create_apps_directories(self, app):
        """def para criar os diretórios das apps dentro do projeto Flutter Mobile"""
        try:
            AppsMobileDirectoriesBuilder(command=self, app=app).build()
        except Exception as error:
    ...
    def _inject_routes_app_in_root_route(self, flutter_project):
        ...
        try:
            ...
            AppsMobileRouterInjectRootRouteBuilder(command=self, flutter_project=flutter_project).build()
        except Exception as error:
    ...
    def _inject_provider_in_main(self, flutter_project):
        ...
        try:
            Utils.show_message("Injetando os routers das apps no arquivo app.routes.dart")
            AppsMobileInjectProvidersBuilder(command=self, flutter_project=flutter_project).build()
        except Exception as error:
            Utils.show_error(f"Error in _inject_routes_app_in_root_route: {error}")
